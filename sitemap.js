var theTotalPosts = 9999, // Tentukan jumlah maksimal posting
    ...
    theSiteUrl = "http://nazfra.blogspot.com", // URL blog kamu
...
function toc_sort_table(a) {
    ...
    skeleton += '</tr></thead>';
    skeleton += '<tbody id="toc-903298438493857447451">'; // Unique ID doh...
    for (var c = 0; c <= theTotalPosts; c++) {
    ...
    skeleton += '</tbody>';
    skeleton += '</table><div style="text-align:right;"><a href="http://nazfra.blogspot.com" target="_blank" style="font:normal bold 8px/normal Arial,Sans-Serif;color:#666;text-shadow:0 1px 0 rgba(255,255,255,.2);" title="SEO sitemap Nazfra">SEO sitemap Nazfra</a></div>';
...
function displayMessage(a) {
    var b = document.getElementById("toc-903298438493857447451");
